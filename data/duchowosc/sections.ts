import { IntroData } from "./duchowosc-types";
...
export const aboutData: IntroData[] = [
  ...
  },
  {
    ...
    title: " Kim jesteśmy ?",
    subtitle:
      "Monastyr Świętego Krzysztofa to przede wszystkim wspólnota chrześcijańska",
    content: [
  ...
  },
  {
    ...
    subtitle: "Jesteśmy ekumeniczni. </br> Co to oznacza w praktyce?",
    content: [
  ...
  },
  {
    id: "co-nas-laczy",
    title: "Co nas łączy?",
    subtitle: "Łączy nas wiara w Boga w Trójcy Świętej.",
    content: [
  ...
  {
    id: "co-nas-dzieli",
    title: "A co z tym, co nas dzieli?",
    subtitle:
      "Każde wyznanie, denominacja czy Kościół ma swoje tradycje, zasady, a czasem i dogmaty.",
    content: [
  ...
  {
    id: "czy-jestesmy-zakonem",
    subtitle: "Nie. Nie jesteśmy zakonem żadnego obrządku chrześcijańskiego.",
    title: "Czy jesteśmy zakonem?",
    content: [
